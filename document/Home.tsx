...
import { defaultLocale, getLocaleFromPath } from "@/lib/i18n/getLocale";
...
export default function Home() {
  ...
  const defaultRollingTexts = translations[defaultLocale].home?.rollingTexts ?? [
    "유저를 이해하세요",
    "데이터를 이해하고",
    "데이터로 토론하세요"
  ];
  const rollingTexts = translation.home?.rollingTexts ?? defaultRollingTexts;
