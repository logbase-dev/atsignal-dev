    ...
    <aside id="sidebar" className="sidebar">
      <ul className="sidebar-nav" id="sidebar-nav">
        ...
        */}
        ...
        <li className="nav-item">
          <a 
            className={`nav-link ${pathname?.startsWith('/newsletter') ? '' : 'collapsed'}`}
          ...
          <ul 
            id="newsletter-nav" 
            className={`nav-content collapse ${pathname?.startsWith('/newsletter') ? 'show' : ''}`}
            data-bs-parent="#sidebar-nav"
          >
            <li>
              <Link 
                href="/newsletter/subscribers"
                className={pathname === '/newsletter/subscribers' ? 'active' : ''}
              >
                <i className="bi bi-circle"></i>
                <span>가입자</span>
              </Link>
            ...
            <li>
              <Link 
                href="/newsletter/send-history"
                className={pathname?.startsWith('/newsletter/send-history') ? 'active' : ''}
              >
                <i className="bi bi-circle"></i>
                <span>발송 이력</span>
              </Link>
        ...
        <li className="nav-item">
          <Link 
            href="/admins"
            className={`nav-link ${pathname?.startsWith('/admins') ? '' : 'collapsed'}`}
          >
